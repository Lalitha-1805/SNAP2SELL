...
export const productService = {
  ...
  getFarmerProducts: (farmerId, page = 1) =>
    api.get(`/products/farmer/${farmerId}`, { params: { page } })
}

export const orderService = {
  createOrder: (data) => api.post('/orders', data),
  getOrders: (page = 1, status = null) =>
...
export const reviewService = {
  createReview: (productId, data) => api.post('/reviews', { ...data, product_id: productId }),
...
export const mlService = {
  recommendCrops: (data) => api.post('/ml/crop-recommendation', data),
  predictPrice: (data) => api.post('/ml/price-prediction', data),
...
export const chatbotService = {
  ...
  getKBStats: () => api.get('/chatbot/kb-stats'),
  addDocument: (data) => api.post('/chatbot/add-document', data)
}
